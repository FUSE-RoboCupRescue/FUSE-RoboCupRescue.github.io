...
export default function Home() {
  return (
    <div className="flex flex-col xl:mx-[25rem] my-5 font-helvetica relative">
      <h1 className="font-bold text-5xl md:text-7xl text-colors-black text-center">SPONSORS</h1>

      {/* Static Sponsor Message */}
      <div className="static bottom-0 left-0 bg-blue-600 text-white p-6 rounded-lg shadow-lg w-[300px]">
